...
public class Q098 {  //학생 클래스를 구현하시오.
...
class Student{
	...
	public String info() {  //덤프
		return String.format("%s(나이 : %s, 학년 : %s, 반 : %s, 번호 : %s)\n", this.name, this.age==0?"미정":this.age+"세", this.grade==0?"미정":this.grade, this.classNumber==0?"미정":this.classNumber, this.number==0?"미정":this.number);	
	}
